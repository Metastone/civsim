...
/// Frequency of 1 means that each cell of perlin noise has a size of 1 in simulation coordinates
/// Amplitude of 1 means that the result is in [-1; 1]
pub fn perlin_noise(mut x: f64, mut y: f64, frequency: f64, amplitude: f64) -> f64 {
    x *= frequency;
    y *= frequency;
    ...
    interpolate(i_x0, i_x1, r_y0) * amplitude
}
