...
pub const INITIAL_ZOOM: f64 = 100.0;
...
pub const CREATURE_SIZE: u32 = 30;
pub const FOOD_SIZE: u32 = 10;
pub const OBSTACLE_SIZE: u32 = 85;
...
pub const GRAPH_EDGE_THICKNESS: usize = 5;
...
pub const HERBIVOROUS_NB: usize = 100;
pub const CARNIVOROUS_NB: usize = 2;
pub const FOOD_NB: usize = 100;
pub const CORPSE_NB: usize = 0;
pub const OBSTACLES_NB: usize = 20;
